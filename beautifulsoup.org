...
응용문제로 아래 URL의 HTML에서 정보를 추출해보겠습니다. 아래의 URL은 포털 서비스인 다음 아고라 서비스의 주소입니다. 여기에서 글 제목과 글쓴이, 글의 URL 주소를 가져오겠습니다.
...
코드 줄 수는 여러줄이지만, 핵심 내용은 간단합니다. 의사 코드로 한번 살펴볼까요?
...
글의 목록은 이렇게 가져올 수 있고, 이번에는 특정한 게시물 하나를 방문해보겠습니다.
